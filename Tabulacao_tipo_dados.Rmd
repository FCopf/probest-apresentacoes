...
1. Estruturas complexas de informações
...
```{r}
image_read('img/Niveis_de_mensuracao.jpg') %>% image_scale("x35 0")
...
# Estruturas complexas de informações


```{r}

image_read("img/banco-de-dados.jpg") %>% 
  image_scale("400x")
```
