...
```{r, fig.height = hf, fig.width = hf}
cov_negativa = mmq(dp = desvio, sem = semente, 
    pt_selected = c(1, 14), show_pt_selected = TRUE, pt_size = 3, 
    show_seg_dx = TRUE, show_xmean_line = TRUE,
    show_seg_dy = TRUE, show_ymean_line = TRUE,
    show_text_dy = TRUE, show_text_dx = TRUE,
...
```{r, fig.height = hf, fig.width = hf}
cov_positiva = mmq(b0 = 725, b1 = 4, dp = desvio, sem = semente, 
...
```{r, fig.height = hf, fig.width = hf}
cov_nula = mmq(b0 = 775, b1 = 0, n = 30, dp = desvio, sem = 6, 
...
cov_negativa = cov_negativa + 
  labs(title = "Covariância Negativa") +
  theme(plot.title = element_text(hjust = 0.5))
cov_nula = cov_nula + labs(title = "Covariância Nula") +
  theme(plot.title = element_text(hjust = 0.5))
cov_positiva = cov_positiva + labs(title = "Covariância Positiva") +
  theme(plot.title = element_text(hjust = 0.5))

cov_negativa | cov_nula | cov_positiva
```
...
```{r, fig.align='center', fig.height=6.5, fig.width=10}
