...
$$s^2 = QM_{Res} = \frac{\sum_{i=1}^{n}{(Y_i - \overline{Y})^2}}{n-2}$$
...
$$SQ_{Reg} = \sum_{i=1}^{n}{(\hat{Y}_i-\overline{Y})}$$
...
$$SQ_{Res} = \sum_{i=1}^{n}{(Y_i-\hat{Y}_i)}$$
...
$$SQ_{Res} = \sum_{i=1}^{n}{(Y_i-\overline{Y})}$$
