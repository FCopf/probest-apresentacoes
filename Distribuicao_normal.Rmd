...
Calculando de $P(X)$ no R: a função `pnorm()`
...
Historicamente, o cáuculo da área na distribuição normal foi conduzido com o uso da distribuição normal **padronizada**.
