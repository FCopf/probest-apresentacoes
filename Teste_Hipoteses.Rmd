...
Elabel <- expression(-(bar(X) - mu), +(bar(X) - mu))
...
$P(Z \ge |Z_{calculado}|) = `r pz` + `r pz` = `r pz * 2` \ge 0,05$

___

Portanto:

Valor de p = $`r pz * 2`$ que é $\ge 0,05$. 
...
$H_a: \mu \ge 65$ batimentos por minuto (Teste UNILATERAL)
...
| $H_0$ é aceita    | $\alpha$ (Decisão correta) | $\beta$ (**Erro Tipo II**)
